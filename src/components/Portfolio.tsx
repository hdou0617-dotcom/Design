  ...
  return (
    <div className="relative w-full h-full overflow-hidden bg-transparent flex items-center justify-center">
      ...
      {!hasError && (
        <img
          ref={handleImageRef}
          src={currentSrc && currentSrc.startsWith('data:') ? currentSrc : getCacheBustedUrl(safeEncodeUrl(currentSrc))}
            ...
            >
              {!modalImgError ? (
                <img
                  ...
                  src={modalSrc && modalSrc.startsWith('data:') ? modalSrc : getCacheBustedUrl(safeEncodeUrl(modalSrc))}
